...
namespace Tourze\DifyWorkflowBundle\Tests\DependencyInjection;

use PHPUnit\Framework\Attributes\CoversClass;
use Symfony\Component\DependencyInjection\ContainerBuilder;
use Tourze\DifyWorkflowBundle\DependencyInjection\DifyWorkflowExtension;
 ...
 * @internal
 */
#[CoversClass(DifyWorkflowExtension::class)]
final class DifyWorkflowExtensionTest extends AbstractDependencyInjectionExtensionTestCase
{
    private DifyWorkflowExtension $extension;
    ...
    protected function setUp(): void
    {
        ...
        $this->extension = new DifyWorkflowExtension();
    ...
    public function testLoadLoadsServicesYaml(): void
    {
        ...
        // Check that services are loaded by verifying key services exist
        $this->assertTrue($this->container->hasDefinition('Tourze\DifyWorkflowBundle\Service\WorkflowService'));
    }
    ...
    public function testLoadSetsCorrectAutowiring(): void
    {
        ...
        foreach ($definitions as $id => $definition) {
            if (str_starts_with($id, 'Tourze\DifyWorkflowBundle\\')) {
